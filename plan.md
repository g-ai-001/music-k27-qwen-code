...
- [x] 修复 SharedPlayerViewModel Player.Listener 内存泄漏
- [x] 优化 PlayerScreen Slider 拖动闪烁问题
- [x] 修复音频焦点恢复时自动播放问题（尊重用户手动暂停）
- [x] 优化 Logger 线程安全性（使用 ThreadLocal）
- [x] 修复 SharedPlayerViewModel 单元测试运行时异常
- [x] 更新版本号至 0.3.1
- [x] 通过 GitHub Actions CI 流水线
- [x] 创建 Git Tag v0.3.1 发布
